...
ardupilot_base = "/home/ubuntu/lab/ardupilot/build/AIRLink"
...
fuzzer = Fuzzer(
    ardupilot_base, adapter, config=config1, seed_macro_file="src/adapter/ardupilot/macros.json", verbose=True
)
...
fuzzer.mutate(target_thread_functions, methods=["related", "sat-solve", "sat-validate"])
