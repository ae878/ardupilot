...
dronin_base = "/home/ubuntu/lab/dRonin"
dronin_build_dir = "/home/ubuntu/lab/dRonin/build"
...
condition = Condition("src/adapter/dronin/condition_analysis_result.json")
config = ConfigFactory("src/adapter/dronin/macros.json", condition)
...
adapter = DroninAdapter(
    ...
    verbose=True,
    build_base=dronin_build_dir,
)


fuzzer = Fuzzer(dronin_base, adapter, config=config, verbose=True)
fuzzer.initial_analyze(target_thread_functions, "initial_analyze_dronin")
