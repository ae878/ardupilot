...
REPO_URL="https://github.com/stacksmash-vuln/striso-control-firmware"
...
echo "Starting striso-control-firmware install script"
...
# 3. Clone striso-control-firmware
echo "[STEP 3] Cloning striso-control-firmware repository..."
if [ -d striso-control-firmware ]; then
    rm -rf striso-control-firmware
fi
...
# 6. Build firmware
echo "[STEP 6] Building striso-control-firmware firmware..."
make

echo "------------------------------------------"
echo " striso-control-firmware install complete! "
echo " Directory: $LAB_PATH/striso-control-firmware "
echo " Build success! "
echo "------------------------------------------"
